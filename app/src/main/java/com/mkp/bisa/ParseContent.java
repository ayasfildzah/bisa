        ...
        try {
            ...
            if (jsonObject.getString(KEY_SUCCESS).equals("true")) {
                ...
                for (int i = 0; i < dataArray.length(); i++) {
                    ...
                    preferenceHelper.putName(dataobj.getString(konfigurasi.TAG_ID));
                    preferenceHelper.putName(dataobj.getString(konfigurasi.TAG_NAMA));
                    preferenceHelper.putHobby(dataobj.getString(konfigurasi.TAG_CREAT));
                }
            }
        } catch (JSONException e) {
            e.printStackTrace();
